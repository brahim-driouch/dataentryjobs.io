        ...
        <div className="border-t pt-6">
          ...
          <div className="mt-4">
            ...
            <input
              type="date"
              name="expiresDate"
              value={formData.expiresDate ? new Date(formData.expiresDate).toISOString().split('T')[0] : ''}
              onChange={(e) => updateFormData({ expiresDate: e.target.value ? new Date(e.target.value) : undefined })}
          ...
          <div className="mt-4">
            <label className="flex items-center">
              <input
                type="checkbox"
                name="urgentHiring"
                checked={formData.urgentHiring || false}
                onChange={(e) => updateFormData({ urgentHiring: e.target.checked })}
                className="mr-2"
              />
